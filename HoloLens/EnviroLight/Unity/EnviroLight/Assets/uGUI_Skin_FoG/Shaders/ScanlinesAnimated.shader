...
////// Emissive:
                ...
                float node_1137 = ((pow(frac((1.0 - ((float2(i.posWorld.g,i.posWorld.g)*float2(_Value,_ScanlineDensity))+(float2(_ScanlineSpeed1,_ScanlineSpeed2)*node_8463.r))).g),_ScanlineExponent)*_ScanlineOpacity)+_Opacity);
